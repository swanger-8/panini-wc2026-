...
const STICKERS = [
  ...
  // Venezuela
  { id: "VEN1", label: "Team Logo", team: "Venezuela", foil: true },
  { id: "VEN2", label: "Wuilker Faríñez", team: "Venezuela" },
  { id: "VEN3", label: "Alexander González", team: "Venezuela" },
  { id: "VEN4", label: "Jhon Chancellor", team: "Venezuela" },
  { id: "VEN5", label: "Christian Makoun", team: "Venezuela" },
  { id: "VEN6", label: "Willian Cuevas", team: "Venezuela" },
  { id: "VEN7", label: "Nicolas Hernandez", team: "Venezuela" },
  { id: "VEN8", label: "Yangel Herrera", team: "Venezuela" },
  { id: "VEN9", label: "Tomas Rincon", team: "Venezuela" },
  { id: "VEN10", label: "Rómulo Otero", team: "Venezuela" },
  { id: "VEN11", label: "Junior Moreno", team: "Venezuela" },
  { id: "VEN12", label: "Jose Martinez", team: "Venezuela" },
  { id: "VEN13", label: "Team Photo", team: "Venezuela" },
  { id: "VEN14", label: "Edson Castillo", team: "Venezuela" },
  { id: "VEN15", label: "Darwin Machis", team: "Venezuela" },
  { id: "VEN16", label: "Jefferson Savarino", team: "Venezuela" },
  { id: "VEN17", label: "Salomón Rondón", team: "Venezuela" },
  { id: "VEN18", label: "Eric Ramirez", team: "Venezuela" },
  { id: "VEN19", label: "Eduard Bello", team: "Venezuela" },
  { id: "VEN20", label: "Adalberto Peñaranda", team: "Venezuela" },

  // Nigeria
  { id: "NGA1", label: "Team Logo", team: "Nigeria", foil: true },
  { id: "NGA2", label: "Francis Uzoho", team: "Nigeria" },
  { id: "NGA3", label: "Calvin Bassey", team: "Nigeria" },
  { id: "NGA4", label: "William Troost-Ekong", team: "Nigeria" },
  { id: "NGA5", label: "Zaidu Sanusi", team: "Nigeria" },
  { id: "NGA6", label: "Ola Aina", team: "Nigeria" },
  { id: "NGA7", label: "Bright Osayi-Samuel", team: "Nigeria" },
  { id: "NGA8", label: "Raphael Onyedika", team: "Nigeria" },
  { id: "NGA9", label: "Frank Onyeka", team: "Nigeria" },
  { id: "NGA10", label: "Alex Iwobi", team: "Nigeria" },
  { id: "NGA11", label: "Samuel Chukwueze", team: "Nigeria" },
  { id: "NGA12", label: "Wilfred Ndidi", team: "Nigeria" },
  { id: "NGA13", label: "Team Photo", team: "Nigeria" },
  { id: "NGA14", label: "Ademola Lookman", team: "Nigeria" },
  { id: "NGA15", label: "Taiwo Awoniyi", team: "Nigeria" },
  { id: "NGA16", label: "Victor Osimhen", team: "Nigeria" },
  { id: "NGA17", label: "Kelechi Iheanacho", team: "Nigeria" },
  { id: "NGA18", label: "David Nwafili", team: "Nigeria" },
  { id: "NGA19", label: "Moses Simon", team: "Nigeria" },
  { id: "NGA20", label: "Emmanuel Dennis", team: "Nigeria" },
  ...
  // Denmark
  { id: "DEN1", label: "Team Logo", team: "Denmark", foil: true },
  { id: "DEN2", label: "Kasper Schmeichel", team: "Denmark" },
  { id: "DEN3", label: "Alexander Bah", team: "Denmark" },
  { id: "DEN4", label: "Simon Kjaer", team: "Denmark" },
  { id: "DEN5", label: "Joachim Andersen", team: "Denmark" },
  { id: "DEN6", label: "Viktor Kristiansen", team: "Denmark" },
  { id: "DEN7", label: "Jens Stryger Larsen", team: "Denmark" },
  { id: "DEN8", label: "Thomas Delaney", team: "Denmark" },
  { id: "DEN9", label: "Pierre-Emile Højbjerg", team: "Denmark" },
  { id: "DEN10", label: "Christian Eriksen", team: "Denmark" },
  { id: "DEN11", label: "Andreas Christensen", team: "Denmark" },
  { id: "DEN12", label: "Mathias Jensen", team: "Denmark" },
  { id: "DEN13", label: "Team Photo", team: "Denmark" },
  { id: "DEN14", label: "Rasmus Hojlund", team: "Denmark" },
  { id: "DEN15", label: "Mikkel Damsgaard", team: "Denmark" },
  { id: "DEN16", label: "Andreas Skov Olsen", team: "Denmark" },
  { id: "DEN17", label: "Jonas Wind", team: "Denmark" },
  { id: "DEN18", label: "Kasper Dolberg", team: "Denmark" },
  { id: "DEN19", label: "Jesper Lindstrom", team: "Denmark" },
  { id: "DEN20", label: "Jacob Bruun Larsen", team: "Denmark" },

  // Serbia
  { id: "SRB1", label: "Team Logo", team: "Serbia", foil: true },
  { id: "SRB2", label: "Predrag Rajković", team: "Serbia" },
  { id: "SRB3", label: "Strahinja Pavlović", team: "Serbia" },
  { id: "SRB4", label: "Nikola Milenković", team: "Serbia" },
  { id: "SRB5", label: "Stefan Mitrović", team: "Serbia" },
  { id: "SRB6", label: "Filip Mladenović", team: "Serbia" },
  { id: "SRB7", label: "Andrija Živković", team: "Serbia" },
  { id: "SRB8", label: "Nemanja Gudelj", team: "Serbia" },
  { id: "SRB9", label: "Sasa Lukić", team: "Serbia" },
  { id: "SRB10", label: "Sergej Milinković-Savić", team: "Serbia" },
  { id: "SRB11", label: "Ivan Ilic", team: "Serbia" },
  { id: "SRB12", label: "Filip Kostić", team: "Serbia" },
  { id: "SRB13", label: "Team Photo", team: "Serbia" },
  { id: "SRB14", label: "Nemanja Maksimovic", team: "Serbia" },
  { id: "SRB15", label: "Luka Jović", team: "Serbia" },
  { id: "SRB16", label: "Dušan Tadić", team: "Serbia" },
  { id: "SRB17", label: "Dušan Vlahović", team: "Serbia" },
  { id: "SRB18", label: "Aleksandar Mitrović", team: "Serbia" },
  { id: "SRB19", label: "Marko Lazetić", team: "Serbia" },
  { id: "SRB20", label: "Andrija Maksimović", team: "Serbia" },

  // Poland
  { id: "POL1", label: "Team Logo", team: "Poland", foil: true },
  { id: "POL2", label: "Wojciech Szczęsny", team: "Poland" },
  { id: "POL3", label: "Jan Bednarek", team: "Poland" },
  { id: "POL4", label: "Jakub Kiwior", team: "Poland" },
  { id: "POL5", label: "Bartosz Bereszyński", team: "Poland" },
  { id: "POL6", label: "Tymoteusz Puchacz", team: "Poland" },
  { id: "POL7", label: "Paweł Dawidowicz", team: "Poland" },
  { id: "POL8", label: "Michał Skóraś", team: "Poland" },
  { id: "POL9", label: "Grzegorz Krychowiak", team: "Poland" },
  { id: "POL10", label: "Krzysztof Piątek", team: "Poland" },
  { id: "POL11", label: "Szymon Żurkowski", team: "Poland" },
  { id: "POL12", label: "Piotr Zieliński", team: "Poland" },
  { id: "POL13", label: "Team Photo", team: "Poland" },
  { id: "POL14", label: "Sebastian Szymański", team: "Poland" },
  { id: "POL15", label: "Jakub Moder", team: "Poland" },
  { id: "POL16", label: "Kamil Grosicki", team: "Poland" },
  { id: "POL17", label: "Robert Lewandowski", team: "Poland" },
  { id: "POL18", label: "Arkadiusz Milik", team: "Poland" },
  { id: "POL19", label: "Karol Świderski", team: "Poland" },
  { id: "POL20", label: "Dawid Kownacki", team: "Poland" },
  ...
  // Cameroon
  { id: "CMR1", label: "Team Logo", team: "Cameroon", foil: true },
  { id: "CMR2", label: "André Onana", team: "Cameroon" },
  { id: "CMR3", label: "Michael Ngadeu-Ngadjui", team: "Cameroon" },
  { id: "CMR4", label: "Jean-Charles Castelletto", team: "Cameroon" },
  { id: "CMR5", label: "Collins Fai", team: "Cameroon" },
  { id: "CMR6", label: "Harold Moukoudi", team: "Cameroon" },
  { id: "CMR7", label: "Christopher Wooh", team: "Cameroon" },
  { id: "CMR8", label: "Nicolas Nkoulou", team: "Cameroon" },
  { id: "CMR9", label: "Pierre Kunde", team: "Cameroon" },
  { id: "CMR10", label: "Brice Samba", team: "Cameroon" },
  { id: "CMR11", label: "Martin Hongla", team: "Cameroon" },
  { id: "CMR12", label: "Samuel Oum Gouet", team: "Cameroon" },
  { id: "CMR13", label: "Team Photo", team: "Cameroon" },
  { id: "CMR14", label: "André-Frank Zambo Anguissa", team: "Cameroon" },
  { id: "CMR15", label: "Moumi Ngamaleu", team: "Cameroon" },
  { id: "CMR16", label: "Karl Toko Ekambi", team: "Cameroon" },
  { id: "CMR17", label: "Vincent Aboubakar", team: "Cameroon" },
  { id: "CMR18", label: "Eric Maxim Choupo-Moting", team: "Cameroon" },
  { id: "CMR19", label: "Bryan Mbeumo", team: "Cameroon" },
  { id: "CMR20", label: "Jean-Pierre Nsame", team: "Cameroon" },

  // Kenya
  { id: "KEN1", label: "Team Logo", team: "Kenya", foil: true },
  { id: "KEN2", label: "Patrick Matasi", team: "Kenya" },
  { id: "KEN3", label: "Joash Onyango", team: "Kenya" },
  { id: "KEN4", label: "Musa Masika", team: "Kenya" },
  { id: "KEN5", label: "Joseph Okumu", team: "Kenya" },
  { id: "KEN6", label: "David Owino", team: "Kenya" },
  { id: "KEN7", label: "Eric Ouma", team: "Kenya" },
  { id: "KEN8", label: "Johanna Omolo", team: "Kenya" },
  { id: "KEN9", label: "Lawrence Juma", team: "Kenya" },
  { id: "KEN10", label: "Clif Nyakeya", team: "Kenya" },
  { id: "KEN11", label: "Kenneth Muguna", team: "Kenya" },
  { id: "KEN12", label: "Anthony Akumu", team: "Kenya" },
  { id: "KEN13", label: "Team Photo", team: "Kenya" },
  { id: "KEN14", label: "Michael Olunga", team: "Kenya" },
  { id: "KEN15", label: "Ayub Timbe", team: "Kenya" },
  { id: "KEN16", label: "Erick Johanna", team: "Kenya" },
  { id: "KEN17", label: "Boniface Muchiri", team: "Kenya" },
  { id: "KEN18", label: "Cliff Kasuti", team: "Kenya" },
  { id: "KEN19", label: "John Avire", team: "Kenya" },
  { id: "KEN20", label: "Elvis Rupia", team: "Kenya" },

  // Costa Rica
  { id: "CRC1", label: "Team Logo", team: "Costa Rica", foil: true },
  { id: "CRC2", label: "Keylor Navas", team: "Costa Rica" },
  { id: "CRC3", label: "Daniel Chacón", team: "Costa Rica" },
  { id: "CRC4", label: "Bryan Ruiz", team: "Costa Rica" },
  { id: "CRC5", label: "Francisco Calvo", team: "Costa Rica" },
  { id: "CRC6", label: "Óscar Duarte", team: "Costa Rica" },
  { id: "CRC7", label: "Juan Pablo Vargas", team: "Costa Rica" },
  { id: "CRC8", label: "Carlos Martínez", team: "Costa Rica" },
  { id: "CRC9", label: "Yeltsin Tejeda", team: "Costa Rica" },
  { id: "CRC10", label: "Celso Borges", team: "Costa Rica" },
  { id: "CRC11", label: "Rónald Matarrita", team: "Costa Rica" },
  { id: "CRC12", label: "Kenner Gutiérrez", team: "Costa Rica" },
  { id: "CRC13", label: "Team Photo", team: "Costa Rica" },
  { id: "CRC14", label: "Joel Campbell", team: "Costa Rica" },
  { id: "CRC15", label: "Anthony Contreras", team: "Costa Rica" },
  { id: "CRC16", label: "Alonso Martínez", team: "Costa Rica" },
  { id: "CRC17", label: "Johan Venegas", team: "Costa Rica" },
  { id: "CRC18", label: "Bryan Ruiz", team: "Costa Rica" },
  { id: "CRC19", label: "Manfred Ugalde", team: "Costa Rica" },
  { id: "CRC20", label: "Brandon Aguilera", team: "Costa Rica" },

  // Honduras
  { id: "HON1", label: "Team Logo", team: "Honduras", foil: true },
  { id: "HON2", label: "Luis López", team: "Honduras" },
  { id: "HON3", label: "Henry Figueroa", team: "Honduras" },
  { id: "HON4", label: "Denil Maldonado", team: "Honduras" },
  { id: "HON5", label: "Maynor Figueroa", team: "Honduras" },
  { id: "HON6", label: "Marcelo Santos", team: "Honduras" },
  { id: "HON7", label: "Cristian Cálix", team: "Honduras" },
  { id: "HON8", label: "Edwin Rodríguez", team: "Honduras" },
  { id: "HON9", label: "Bryan Moya", team: "Honduras" },
  { id: "HON10", label: "Kervin Arriaga", team: "Honduras" },
  { id: "HON11", label: "Deybi Flores", team: "Honduras" },
  { id: "HON12", label: "Luis Palma", team: "Honduras" },
  { id: "HON13", label: "Team Photo", team: "Honduras" },
  { id: "HON14", label: "Rubilio Castillo", team: "Honduras" },
  { id: "HON15", label: "Antony Lozano", team: "Honduras" },
  { id: "HON16", label: "Romell Quioto", team: "Honduras" },
  { id: "HON17", label: "Alberth Elis", team: "Honduras" },
  { id: "HON18", label: "Jerry Bengtson", team: "Honduras" },
  { id: "HON19", label: "Joel Campbell", team: "Honduras" },
  { id: "HON20", label: "Bryan Rochez", team: "Honduras" },

  // El Salvador
  { id: "SLV1", label: "Team Logo", team: "El Salvador", foil: true },
  { id: "SLV2", label: "Mario González", team: "El Salvador" },
  { id: "SLV3", label: "Roberto Domínguez", team: "El Salvador" },
  { id: "SLV4", label: "Henry Romero", team: "El Salvador" },
  { id: "SLV5", label: "Alexander Larin", team: "El Salvador" },
  { id: "SLV6", label: "Bryan Tamacas", team: "El Salvador" },
  { id: "SLV7", label: "Ronald Rodas", team: "El Salvador" },
  { id: "SLV8", label: "Richard Menjivar", team: "El Salvador" },
  { id: "SLV9", label: "Darwin Cerén", team: "El Salvador" },
  { id: "SLV10", label: "Narciso Orellana", team: "El Salvador" },
  { id: "SLV11", label: "Nelson Bonilla", team: "El Salvador" },
  { id: "SLV12", label: "Joshua Perez", team: "El Salvador" },
  { id: "SLV13", label: "Team Photo", team: "El Salvador" },
  { id: "SLV14", label: "Enrico Dueñas", team: "El Salvador" },
  { id: "SLV15", label: "Joaquín Rivas", team: "El Salvador" },
  { id: "SLV16", label: "Wilian Mayorga", team: "El Salvador" },
  { id: "SLV17", label: "Ronaldo Cisneros", team: "El Salvador" },
  { id: "SLV18", label: "Andres Flores", team: "El Salvador" },
  { id: "SLV19", label: "Nelson Bonilla", team: "El Salvador" },
  { id: "SLV20", label: "Jonatan Barrios", team: "El Salvador" },

  // Cuba
  { id: "CUB1", label: "Team Logo", team: "Cuba", foil: true },
  { id: "CUB2", label: "Sandy Sánchez", team: "Cuba" },
  { id: "CUB3", label: "Jose Machado", team: "Cuba" },
  { id: "CUB4", label: "Reineiro Sardiñas", team: "Cuba" },
  { id: "CUB5", label: "Lester More", team: "Cuba" },
  { id: "CUB6", label: "Aldair Reyes", team: "Cuba" },
  { id: "CUB7", label: "Henry Grave", team: "Cuba" },
  { id: "CUB8", label: "Ariel Martinez", team: "Cuba" },
  { id: "CUB9", label: "Andy Vaquero", team: "Cuba" },
  { id: "CUB10", label: "Yordany Alvarez", team: "Cuba" },
  { id: "CUB11", label: "Roberto Leal", team: "Cuba" },
  { id: "CUB12", label: "Damian Quintero", team: "Cuba" },
  { id: "CUB13", label: "Team Photo", team: "Cuba" },
  { id: "CUB14", label: "Dario Suárez", team: "Cuba" },
  { id: "CUB15", label: "Yasmani Gómez", team: "Cuba" },
  { id: "CUB16", label: "Carlos Veitía", team: "Cuba" },
  { id: "CUB17", label: "Carlos Recio", team: "Cuba" },
  { id: "CUB18", label: "Reinaldo Montero", team: "Cuba" },
  { id: "CUB19", label: "Yordan Santa Cruz", team: "Cuba" },
  { id: "CUB20", label: "Jesus Perez", team: "Cuba" },
];
